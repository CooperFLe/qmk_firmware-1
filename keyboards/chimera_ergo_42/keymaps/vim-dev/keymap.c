...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
     LGUI, Q  , W  , E  , R  , T  ,       Y  , U  , I  , O  , P  ,ENT ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
     TAB , A  , S  , D  , F  , G  ,       H  , J  , K  , L  ,SCLN,QUOT,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
     LSPO, Z  , X  , C  , V  , B  ,       N  , M  ,COMM,DOT ,SLSH,RSPC,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
                    LCTL,BSPC,NMPD,      SYMB,SPC ,RALT
  // \------------------+----+----/      \---+----+----+--------------/
  ),
  ...
  [_SYMBOLS] = KC_KEYMAP(
  //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
     MESC,EXLM, AT ,HASH,DLR ,PERC,      CIRC,AMPR,ASTR,LPRN,RPRN,BSLS,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
     TILD,EQL ,UNDS,LCBR,RCBR,PIPE,      LEFT,DOWN, UP ,RGHT,    ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
     GRV ,PLUS,MINS,LBRC,RBRC,    ,       F1 , F2 , F3 , F4 , F5 ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
                        ,    ,SYMB,      SYMB,    ,
  // \------------------+----+----/      \---+----+----+--------------/
  ),
